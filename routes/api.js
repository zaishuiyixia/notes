...
1. 获取所有的 note：GET请求 接口为：/api/notes
2. 创建一个 note：POST请求 接口为：/api/note/add
3. 修改一个 note：POST请求 接口为：/api/notes/edit
4. 删除一个 note：POST请求 接口为：/api/note/delete

*/

/* 获取所有的 notes */
router.get('/notes', function(req, res, next) {
  // req请求数据、res响应数据、next交给下一个中间件去处理
  var opts = {raw: true}
